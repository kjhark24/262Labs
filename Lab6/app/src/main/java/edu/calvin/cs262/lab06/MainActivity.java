 ...
 *
 * Questions
 * A toast appears saying it could not connect to the service.
 * It is the Open Weather Api Key, Which allows the app to access Open Weather using ther application program interface.
 * JSON response would looks like {
 ...
 * The system takes the json data and puts the relevant data into an array where it latter gets to upadate the ui
 * The weather class stores weather data and has accessors to get that data
 */
